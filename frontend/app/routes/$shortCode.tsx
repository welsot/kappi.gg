import { getGalleryByShortCode } from '~/api/apiComponents';
import type { GalleryDto, MediaDto } from '~/api/apiSchemas';
...
export default function AuthGalleryView() {
  ...
  useEffect(() => {
    const fetchGallery = async () => {
      ...
      const shortCodeWithoutPrefix = shortCode.startsWith('@') ? shortCode.slice(1) : shortCode;

      try {
        const galleryData = await getGalleryByShortCode({
          pathParams: { shortCode: shortCodeWithoutPrefix },
        });
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="bg-white rounded-xl shadow-lg p-6 mb-6 text-center">
            ...
            <div className="flex items-center justify-center gap-6 text-sm text-gray-600">
              ...
              <div>
                Created on {format(new Date(gallery.createdAt), 'MMMM d, yyyy')}
              </div>
            </div>
          </div>
